  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ListView.builder(
                          ...
                          itemCount: ctrl.faqsList.length,
                          shrinkWrap: true,
                          physics: const NeverScrollableScrollPhysics(),
                          itemBuilder: (context, index) {
                            return expandedTile(
                                ctrl.faqsList[index].question,
                                ctrl.faqsList[index].answer,
                                    () {
                                ...
                                isExpandable: ctrl.index.value == index ? ctrl.visibility.value : false)
        ...
        Obx(() => Visibility(visible: controller.isLoading.value,child: const AppProgress(),))
